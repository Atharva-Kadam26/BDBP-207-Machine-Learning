...
def main():
    X,y=load_data("california_housing.csv")
    ...
    thetas=gradient_descent(X_train_scale_int,thetas,y_train,alpha=1e-6,iterations=5000)
    ...
    print("R2 Score by the model implemented by me from scratch=",r2)
...
#loading the data
 # X=df_upd.drop("disease_score",axis=1)
 X=df.iloc[:,0:8]
 y=df.iloc[:,8]
 ...
 print("R2 score by scikit-learn model:",r2)
